...
/// </summary>
public class OVRDebugInfoSample : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        UIManager.transform.parent = GameObject.Find("LeftEyeAnchor").transform;

        RectTransform rectTransform = UIManager.AddComponent<RectTransform>();
        rectTransform.sizeDelta = new Vector2(100f, 100f);
        rectTransform.localScale = new Vector3(0.001f, 0.001f, 0.001f);
        rectTransform.localPosition = new Vector3(0.01f, 0.17f, 0.53f);
        rectTransform.localEulerAngles = Vector3.zero;

        Canvas canvas = UIManager.AddComponent<Canvas>();
    ...
    void InitUIComponents()
    {
        ...
        UIObject.name = "UIInfo";
        UIObject.transform.parent = GameObject.Find("UIManager").transform;
        UIObject.transform.localPosition = new Vector3(0.0f, 100.0f, 0.0f);
        UIObject.transform.localEulerAngles = Vector3.zero;
        UIObject.transform.localScale = new Vector3(1.0f, 1.0f, 1.0f);
    ...
    GameObject VariableObjectManager(GameObject gameObject, string name, float posY, string str, int fontSize)
    {
        ...
        gameObject.transform.SetParent(UIObject.transform);
